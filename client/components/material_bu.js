  ...
  render () {
    const list = {
      ...
      elements: [
        ...
        python script uses libraries such as <a href="http://www.numpy.org/">numpy</a> (version xx),
        &nbsp;<a href="https://pillow.readthedocs.io/en/5.1.x/">pillow</a> (version xx), ... and the open-source
        software image manipulation software <a href="http://rawtherapee.com/">Rawtherapee</a>
        (version 5.4).
